    ...
    <Section id="co-delat-pri-napadeni" header="Co dělat při napadení?">
      ...
      <Article header="Jak postupovat v případě napadení stáda?">
        ...
        <p>
          ...
          <a
            href="https://www.selmy.cz/data/images/ovce/Ohlaseni_vyssi_moci_-_vyjimecne_okolnosti.pdf"
            target="_blank"
          >
    ...
    <Section id="mapy-utoku" header="Mapy útoků">
      <Article header="">
        ...
        <p>
          ...
          <a
            href="http://www.mapa.selmy.cz/cs?layers=80,88,91,89,92"
            target="_blank"
          >
            {" "}
            www.mapa.selmy.cz
          </a>
          , spolu s informacemi o potvrzených vlčích teritoriích.
        </p>

...
export default () => (
  <>
    ...
    <Article header="Použití">
      <p>
        Pevné ohrady se běžně používají k vymezení pastvin, kde jsou zvířata po
        většinu pastevní sezóny. Tyto ohrady však většinou nejsou postavené tak,
        aby stádo uchránily před útokem predátorů. Aby zvířata ohradou
      ...
      <li>
        ...
        položit a pevně zakotvit pletivo navazující na plot v šířce min. 100 cm
        před ohradníkem .
      </li>
      <p>
      ...
      <p>
        Minimální výška pevné elektrifikované ohrady by stejně jako u mobilních
        ohradníků měla být 120 cm, lze ji navýšit o přídavný drát až do výšky
        150 cm. Samotná ohrada může mít různé podoby: uzlíkové nebo
        vysokopevnostní pletivo na akátových kůlech nebo vypnutné dráty o
        průměru 1,5-2,5 mm pod napětím s rozestupy 20-30 cm, s nejnižším vodičem
        20 cm nad zemí.
      </p>
    </Article>
    <Article header="Účinnost">
    ...
    <Article header="Cena">
      <p>
        Pevná ohrada je velkou vstupní investicí. Pokud však chovatel již pevnou
        ohradu má nebo ji plánuje postavit či obnovit kvůli vymezení pastviny
        pro hospodářská zvířata, nejsou přídavné prvky zajišťující ochranu proti
        vniknutí predátorů většinou významným navýšením - jde zejména o zvýšení
        počtu vodičů tak, aby ohrada splňovala minimální, výše popsané
        parametry. Náklady na následnou údržbu zahrnují zejména pravidelné
        podsekávání, aby nejnižší vodiče nezarůstaly trávou.
      </p>
    </Article>
    <Article header="Požadavky a doporučení při instalaci">
      <ul>
        ...
        <li>Napětí alespoň 4500 V.</li>
        <li>
          Pro funkčnost opatření je zásadní, aby vodiče byly stále pod napětím.
          Je potřeba pravidelně kontrolovat, zda se vodiče nedotýkají vegetace a
          ohradník tak není uzemněný. Lze využít zkoušečky, signální světla či
          SMS hlásiče.
        </li>
        <li>
